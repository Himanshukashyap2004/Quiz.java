...
public class Quiz {
    ...
    public static int find(String name, String pass) {
        try {
            FileReader file3 = new FileReader("C:/Users/LENOVO/OneDrive/Documents/Desktop/javaproject/Credentials.txt");// file object for answer
                                                                                             // file(change the file
                                                                                             // location where the file
                                                                                             // is saved)
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileReader file1 = new FileReader("C:/Users/LENOVO/OneDrive/Documents/Desktop/javaproject/Question.txt");// file object for question
                                                                                      // file(change the file location
                                                                                      // where the file is saved)
        BufferedReader bf = new BufferedReader(file1);
        FileReader file2 = new FileReader("C:/Users/LENOVO/OneDrive/Documents/Desktop/javaproject/Answer.txt");// file object for answer
                                                                                    // file(change the file location
                                                                                    // where the file is saved)
        BufferedReader bf1 = new BufferedReader(file2);
        FileReader file4 = new FileReader("C:/Users/LENOVO/OneDrive/Documents/Desktop/javaproject/CO.txt");// file object for question file(change
                                                                                // the file location where the file is
                                                                                // saved)
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (a == 1) {
                        ...
                        String s1 = "	(CO1:" + Double.toString(c1) + "%	CO2:" + Double.toString(c2) + "%	CO3:"
                                + Double.toString(c3) + "%	CO4:" + Double.toString(c4) + "%)";
                        FileWriter file4 = new FileWriter("C:/Users/LENOVO/OneDrive/Documents/Desktop/javaproject/Score.txt", true);// file object
                                                                                                         // for answer
                                                                                                         // file(change
                                                                                                         // the file
                                                                                                         // location
